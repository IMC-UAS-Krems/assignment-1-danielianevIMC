...
class SingleRelease(Song):
    def __init__(self, track_id: str, title: str, duration_seconds: int, genre: str, artist: Artist, release_date):
...
class AudiobookTrack(Track):
    def __init__(self, track_id: str, title: str, duration_seconds: int, genre: str, author: str, chapter_number: int):
        super().__init__(track_id, title, duration_seconds, genre)
        self.author = author
